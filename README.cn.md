...
[![x-cmd/install — termframe Code Quality Monitoring Repo Card](https://repo.x-cmd.io/termframe.svg?lang=zh)](https://x-cmd.com/install/termframe)
...
- **发布数**: 38 · **已合并 PR**: 610 · **开放 PR**: 1 · **已关闭 issue**: 9 · **开放 issue**: 4 · **提交数**: 649
...
_数据快照: `data/card/260920.yml` · 2026-09-20T06:12:07Z._
